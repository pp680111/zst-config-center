...
/**
 * 用于解析Value注解中的表达式的工具类
 *
 * 复制自 apollo-java库的com.ctrip.framework.apollo.spring.property.PlaceholderHelper类
 */
public class PlaceholderHelper {
    ...
    /**
     * 通过Spring的BeanFactory对象，将@Value注解中的表达式key解析为实际的值
     *
